...
this.document.onmouseover = (e) => {
  if (e.target.classList.contains("output-child")) {
    ...
    // showChildInfo.style.left = e.clientX + 10 + "px";
    // showChildInfo.style.top = e.clientY + 10 + "px";
    // showChildInfo.clientX = e.clientX + 10;
    // showChildInfo.clientY = e.clientY + 10;

    // parentX = e.target.parentNode.clientX;
    // parentY = parent.clientY;
    // console.log(parentX);
    // console.log(parentY);
    // showChildInfo.clientX = 100;
    // showChildInfo.clientY = 100;

    // var rect = e.target.getBoundingClientRect();
    // showChildInfo.style.top = Math.floor(rect.top) + "px";
    // showChildInfo.style.left =
    //   Math.floor(rect.left + showChildInfo.clientWidth + 10) + "px";
    // console.log(
    //   Math.floor(rect.top),
